...
export const ProjectItem: React.FC<ProjectItemProps> = ({ project, role }) => {
  ...
  return (
    <Link to={`/project/${project.id}`} className="block">
      <div className="group p-5 bg-white/50 dark:bg-gray-900/50 rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-blue-500/30 transition-all cursor-pointer">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-bold text-lg group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{project.name}</h3>
